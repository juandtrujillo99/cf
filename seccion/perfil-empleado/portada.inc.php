...
<div class="col-12 row" align="center">
    ...
    <div class="sobreponer2 col-8 d-none d-sm-block">
        <div class="imagen-background">
            <img loading="lazy" style="border-radius: 0px 0px 30px 30px ;" src="<?php echo RUTA_IMG;?>fondos/perfil-empleado.jpg" class="imagen">
        </div>
    </div>
...
<div class="col-12" align="center">
	...
	<?php
	if(file_exists(DIRECTORIO_RAIZ."/empleados/fotos-perfil/".$empleado->obtener_cedula())) {
		?>	
				<a target="_blank" href="<?php echo RUTA_DOCS_EMPLEADOS.'/fotos-perfil/'.$empleado->obtener_cedula(); ?>" data-lightbox="Foto de perfil" data-title="Foto de perfil" class="btn btn-principal-animado">Ver foto</a><br>
	...
	<a class="modal-trigger circle" href="#actualizar">
		<div class="img7 bg-cover col-md-3 col-10" style="background-image:url(<?php echo RUTA_DOCS_EMPLEADOS.'/fotos-perfil/'.$empleado->obtener_cedula(); ?>);"></div>
	</a>
		<?php
	} else {		
			?>
