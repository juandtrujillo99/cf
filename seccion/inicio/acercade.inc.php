<div id="acercade" class="section col-12 row d-none d-sm-block">
    ...
    <div class="texto-contenido3">
    	<h2 class="textoBlack">Visítanos</h2>
        <p class="textoBook">Dirección:</p>
        <a class="white-text" href="<?php echo $ubicacionEmpresa;?>" target="_blank"><h3 class="textoBold"><?php echo $direccionEmpresa1;?></h3></a>
        <p class="textoBook">B/ <?php echo $direccionEmpresa2;?></p>
    </div>
    	...
    	<div class="col-12 row">
    		...
    		<div class="col-6">
    			<div class="col-11">
        			<div class="col-12 row">
        				<br><br>
	        			<h1 class="textoBlack col-10">ACERCA DE CHAMPIONS FIT</h1>
	        			<hr>
	        			<p class="black-text col-10">
	            			Trabajamos con el propósito de mejorar la salud física y mental de las personas, para elevar sus defensas y que estén fuertes, lo hacemos para que se liberen del estrés y se sientan felices
	            			<br><br>
	            		</p>
	        		</div>	        		
		       		<div class="black-text col-12 row">
	    				<H4 class="textoBold col-12">Horario de atención:<br></H4>
		       			<div class="col-6">
		    				<p>Lunes a Viernes</p>
		            ...
		            <a href="<?php echo RUTA_MEMBRESIA; ?>" class="textoBold btn btn-principal-animado">INSCRIBIRSE</a>
	            </div>
    		</div>
    	</div>
    </div>
		...
		<div class="anime-1 row">
    		<div class="section row" style="background-image: url(<?php echo RUTA_IMG;?>fondos/acercade-m.jpg); background-size: cover;">
    			...
    			<div align="center" class="col-12 row texto-contenido2">
	    			...
	    			<div class="col-12">
	    				<a href="<?php echo $ubicacionEmpresa;?>" target="_blank">
