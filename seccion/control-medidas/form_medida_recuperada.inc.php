...
<div class="row">
	...
	<div class="col-md-6 col-xs-12">
		<ul class="collapsible">
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Peso</div>
				<div class="collapsible-body">
					<span>
...
<div class="row">
	<div class="col-md-5 col-xs-12">
		...
		<ul class="collapsible" data-collapsible="expandable">
			<li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Hombro</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
		    ...
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Pecho o busto</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
		    ...
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Espalda</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
		    ...
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Antebrazo</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
		    ...
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Abdomen</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
	...
	<div class="col-md-6 col-xs-12">
		...
		<ul class="collapsible" data-collapsible="expandable">
			<li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Cintura</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
		    ...
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Cadera</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
		    ...
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Pantorrilla</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
		    ...
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Pierna superior</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
		    ...
		    <li>
				<div class="collapsible-header"><i class="material-icons">whatshot</i>Pierna inferior</div>
				<div class="collapsible-body">
					<span>
						<div class="form-group">
