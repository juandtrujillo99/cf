<div class="col-sm-12 col-xs-12">
	...
	<div class="col-sm-10 col-xs-10">
		<div class="col-sm-12">
			...
			<a href="<?php echo RUTA_NUEVO_PRODUCTO; ?>" class="btn col-sm-3" role="button">Crear nueva entrada</a>
						...
						<?php
							for ($i = 0; $i < count($array_entradas); $i++) {
								...
								<div class="col-sm-12 col-xs-12 item">
									...
									<div class="col-sm-3 col-xs-3"><a href="<?php echo RUTA_PRODUCTO . '/' . $entrada_actual -> obtener_url(); ?>" target="_blank"><?php echo $entrada_actual -> obtener_titulo(); ?></a></div>
									<div class="col-sm-2 col-xs-1" align="center"><?php echo number_format($entrada_actual -> obtener_precio()); ?></div>
									<div class="col-sm-1 col-xs-1"></div>
									<div class="col-sm-1 col-xs-3">
										<form method="post" action="<?php echo RUTA_EDITAR_PRODUCTO; ?>">
									...
									<div class="col-sm-1 col-xs-1">
										<form method="post" action="<?php echo RUTA_BORRAR_PRODUCTO; ?>">
